...
<?php require_once("public/page-parts/new/sideNav.php") ?>
                                                ...
                                                <div class="tab-pane fade show active" id="nav-bitcoin" role="tabpanel" aria-labelledby="nav-bitcoin-tab">
                                                    <div class="crypto-single-wallet">
                                                        ...
                                                        <ul class="market-info">
                                                            <li>
                                                                <span>All Completed Surveys</span>
                                                            ...
                                                            <li>
                                                                <span>All Validated Survey </span>
                                                                <h4 id="validSurv"></h4>
                                                                <span>Earnings</span>
                                                                <span><span id="valid_rw" class="d-inline-block my-0"></span> <small><b>SNGY</b></small></span>
                                                            </li>
                                                            <li>
                                                                <span>Completed Participation</span>
                                                                <h4 id="allParticipation"></h4>
                                                                <span>Earnings</span>
    ...
    <script src="/public/static/js/admin_stat.js?v=<?php echo STATIC_VERSION ?>" type="text/javascript"></script>
    <script src="/public/static/js/amount_stat.js?v=<?php echo STATIC_VERSION ?>" type="text/javascript"></script>
    <!-- <script src="/public/static/js/published-surveys.js"></script> -->
    <!-- <script src="/public/static/js/published-events.js"></script> -->
