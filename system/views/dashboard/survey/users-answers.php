                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="transaction-details-wrapper">
                                        <h2 class="crypto-stitle">Survey Participants</h2>
...
?>
                                                    <tr>
                                                        ...
                                                        <td><a href="/survey/unique_answers/<?php echo $title.'5325'.$participant_id.'2358'.$id ?>" class='btn text-white btn-primary'>View Answers</a></td>
                                                    </tr>
<?php
}
?>
